        ...
        <ul class="mt-11 mb-6 w-full list-none overflow-x-auto flex gap-5 justify-between">
            <li :key="column.title" v-for="column in columns"
                ...
                <draggable item-key="id"
                    ...
                    v-model="column.tasks" v-bind="dragOptions" @start="isDragging = true" @end="isDragging = false"
...
<div>
    <vue-final-modal v-model="showModal" classes="modal-container" content-class="modal-content">
        ...
        <div class="all-content">
            ...
            <div class="tasks">
                <div class="task-icon">
                    <img src="\images\ion_pricetags.png" alt="">
                    <label for="">Tarefas</label>
                </div>
                <div class="new-task">
                    <div class="w-8 h-8 ">
                        <img class="w-full" src="\images\Ellipse 6.png" alt="">
                    </div>
